...
if ( $status == "admin")
{
    ...
    echo "</li>";
    echo "<li class='nav-item'>";        
    echo "<a class='nav-link active' aria-current='page' href='Kategorie.php'>Kategorie bearbeiten<i class='bi bi-bag-check-fill' style='font-size: 1rem; color: blueviolet;' ></i></a>";        
    echo "</li>";
    echo "<li class='nav-item'>";
echo "<p>";
echo "<a class='nav-link active' data-toggle='collapse' href='#Kategorie' role='button' aria-expanded='false' aria-controls='collapseExample'>";  
...
echo "</li>";      
    ...
    echo "<li class='nav-item'>";
    echo "<li class='nav-item'>";        
    echo "<a class='nav-link active' aria-current='page'style='color: white;' href='Kategorie.php'>Kategorie bearbeiten<i class='bi bi-bag-check-fill' style='font-size: 1rem; color: blueviolet;' ></i></a>";        
    echo "</li>";  
    echo "</ul>";
    echo "</div>";
    echo "</header>";
