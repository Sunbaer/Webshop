...
if(!$connection){
   ...
   echo "<iframe width='942' height='530' src='https://www.youtube.com/embed/O91DT1pR1ew' title='get rickrolled lol' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' autoplay=1&mute=1 allowfullscreen></iframe>";
}
