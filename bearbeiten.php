            ...
            echo "</head>";
                echo"<div class='container'>";
                    ...
                    echo"</div>";
                     ...
                     echo "</br>";
                     echo"<input type='text'size='5'style='border:white 2px solid;'  value='".$preis."' id='preis' name='preis'></input>";
                    echo"</div>";
                     echo"<div class='col-lg-1' style='border: 1px solid white;'>";
                     echo "<label>KategorieID/s</label>";
                     echo "</br>";
                     echo"<input type='text'size='5'style='border:white 2px solid; width:4em;'  value='".$kategorieId."' id='kategorieId' name='kategorieId'></input>";
                    echo"</div>";
                     echo"<div class='col-lg-1' style='border: 1px solid white;'>";
                    ...
                    echo"</div>"; 
                      echo"<div class='col-lg-1' style='border: 1px solid white;'>";
                        ...
                        echo "<input type='submit' formaction='Produkt.php' value='Zurück'>";
                    echo"</div>"; echo"<div class='row'>";
                    
                         echo"<div class='col-lg-2' style='border: 1px solid white;'>";
                         echo "<label>Produkt Beschreibung</label>";
                         echo "</br>";
                         echo"<textarea style='border: 1px solid white;' form='form' id='beschreibung'  name='beschreibung' >".$beschreibung."</textarea>";
                         echo"</div>"; 

                        echo "<div class='container' style='padding-top: 20px;'>";
                        echo "<div class='row'>";
                        echo "<div class='col-lg-8' style='border: 2px solid white;'> ";
                        echo "Bilder";
                        echo "</div>";
                        echo "<div class='col-lg-4' style='border: 2px solid white;'> ";
                        echo "3D-Ansicht/.glb";
                        echo "</div>";
                        echo "<div class='row'>";
                        echo "<div class='col-lg-2' style='border: 2px solid white;'> ";
            ...
            echo "</head>";
                echo"<div class='container'>";
                    ...
                    echo"</div>"; echo"<div class='row'>";
                         ...
                         echo "<label>Produkt Beschreibung</label>";
                         echo "</br>";
                         echo"<textarea style='border: 1px solid white;' form='form' id='beschreibung' value='".$beschreibung."' name='beschreibung' ></textarea>";
                         echo"</div>"; 
